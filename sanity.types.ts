...
export type Product = {
  ...
  colors?: Array<string>;
  status?: "new" | "hot" | "sale";
  variant?: "men" | "women" | "bags" | "shoes" | "jewelries" | "others";
  isFeatured?: boolean;
};
...
export type MY_ORDERSResult = Array<{
  _id: string;
  _type: "order";
  _createdAt: string;
  _updatedAt: string;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"order\" && clerkUserId == $userId] | order(orderData desc) {...,products[] {..., product ->}}": MY_ORDERSResult;
